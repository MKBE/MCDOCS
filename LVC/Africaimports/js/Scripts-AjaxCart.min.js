        ...
        t(),
            ...
            function() {
                ...
                var timer = setInterval(function(){
                	if($(".k-widget.ajaxCart:hover").length == 0){
			    		if($('.k-widget.ajaxCart').is(':visible')){
			    			$(".ajaxCart .k-window-titlebar.k-header .k-window-actions .k-icon").trigger("click");
			    			clearInterval(timer);
			    		}
			    	}
			    	//console.log($(".k-widget.ajaxCart:hover").length);
				}, 5000);
